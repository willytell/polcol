...
echo "Experiment: Results6-partH02"
...
python3 main.py -c config/conf_dist50-resnet50-bbox-imagenet-exp"$exp".py -a train -e $exp -k $kfold &>logs/dist50-resnet50-bbox-imagenet-exp"$exp"-kfold"$kfold"-train
#python3 main.py -c config/conf_dist50-resnet50-bbox-imagenet-exp"$exp".py -a test  -e $exp -k $kfold &>logs/dist50-resnet50-bbox-imagenet-exp"$exp"-test
