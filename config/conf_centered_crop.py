...
bbox_output_path       = "/home/willytell/Documentos/MCV/M9/TFM/ExperCNN/BBoxCenterCrop"    # directory to write the images from mask
...
model_output_directory = 'resnet50-bbox-imagenet-da'
