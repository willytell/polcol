...
dataset_images_path = "/home/willytell/Documentos/MCV/M9/TFM/ExperCNN/Recortadas"   # all images are in this folder
...
model_output_directory = 'resnet50-from-scratch-using-recortadas-inpainting-images'
