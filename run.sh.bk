...
echo "dist1"
CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist1-resnet50-with_bbox-imagenet.py -a train &>logs/dist1-resnet50-with_bbox-imagenet-train
CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist1-resnet50-with_bbox-imagenet.py -a test  &>logs/dist1-resnet50-with_bbox-imagenet-test
