...
#CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist4-resnet50-with_bbox-imagenet-da.py -a train &>logs/dist4-resnet50-with_bbox-imagenet-da-train
CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist4-resnet50-with_bbox-imagenet-da.py -a test &>logs/dist4-resnet50-with_bbox-imagenet-da-test


#CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist5-resnet50-with_bbox-imagenet-da.py -a train &>logs/dist5-resnet50-with_bbox-imagenet-da-train
CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist5-resnet50-with_bbox-imagenet-da.py -a test &>logs/dist5-resnet50-with_bbox-imagenet-da-test
