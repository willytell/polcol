...
#CUDA_VISIBLE_DEVICES=0 python3 main.py -c config/conf_dist50-resnet50-bbox-imagenet-exp0.py -a test  -e 0 -k 2 &>logs/dist50-resnet50-bbox-imagenet-exp0-test
